...
<script>
    export default {
        ...
        created(){
            // Call the server to get views of blog post
            this.views = 100
            // Get blog post
            let posts = [{title: 'This is title 1', 'post': 'This is blog post 1', id: 1},
            {title: 'This is title 2', 'post': 'This is blog post 2', id: 2},
            {title: 'This is title 3', 'post': 'This is blog post 3', id: 3},
            {title: 'This is title 4', 'post': 'This is blog post 4', id: 4},
            ]
